...
class MainFragment : PreferenceFragmentCompat(), OnSharedPreferenceChangeListener {
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        findPreference<Preference>(KEY_NAME)?.onPreferenceChangeListener = Preference.OnPreferenceChangeListener { _, newValue ->
            newValue != null && validateServerURL(newValue.toString())
        }
    ...
    private fun initPreferences() {
        ...
        if (!sharedPreferences.contains(KEY_DEVICE)) {
            // SET DEVICE ID TO HASH
            // val id = hash(name,phonenumber
            val name = sharedPreferences.getString(MainFragment.KEY_NAME,"unknown");
            val phone = sharedPreferences.getString(MainFragment.KEY_PHONE,"unknown")
            if(!name.equals("unknown")&&!phone.equals("unknown")){
    ...
    companion object {
        ...
        const val KEY_PLATE = "plate_number"
